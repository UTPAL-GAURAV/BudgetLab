              ...
              child: Column(children: [
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: getEditableImagesWallpaperStack('assets/images/icons/expenseList.png', 120, 44, context),
                    // child: getLastIconEditButton(context),
                  ),
                ),
                Container(padding: EdgeInsets.fromLTRB(screenWidth(0.02, context), screenHeight(0.03, context), screenWidth(0.02, context), screenHeight(0.08, context)),
                ...
                Padding(
                  padding: EdgeInsets.only(top: screenHeight(0.08, context), bottom: 60),
                  child: SizedBox(
                    ...
                    child: FloatingActionButton.extended(
                        ...
                        onPressed: () {
                          ...
                          if (formKey.currentState!.validate()) {
                            ...
                            GoRouter.of(context).pushReplacementNamed(AppRouteConstants.groupScreen, extra: group);
                          }
                        }),
                  ),
                ),
