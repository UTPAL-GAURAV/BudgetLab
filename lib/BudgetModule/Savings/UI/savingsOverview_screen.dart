...
class _SavingsOverviewScreenState extends State<SavingsOverviewScreen> {
  ...
  late String savingsTitle, selectedIcon, savingsTargetAmount, originalTitle;
  ...
  void initState() {
    ...
    selectedIcon = widget.savings.icon;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("${widget.savings.title}   (Editing)"),
        ),
        body: MultiProvider(
            providers: [
                    ...
                    children: [
                          ...
                          child: FloatingActionButton.extended(
                              ...
                              onPressed: () {
                                ...
                                if (formKey.currentState!.validate()) {
                                  savingsController.updateSavings(Savings(
                                      title: savingsTitle,
                                      targetAmount: double.parse(savingsTargetAmount),
                                      savedAmount: 0,
                                      icon: 'assets/images/icons/budgetCategory/piggy.png',
                                      targetDateTime: savingsTargetDate), originalTitle);
                      ...
                      SizedBox(
                          ...
                          child: FloatingActionButton.extended(
                              ...
                              onPressed: () {
                                savingsController.deleteSavingsByTitle(savingsTitle);
                                GoRouter.of(context).pushNamed(AppRouteConstants.savings);
                              }))
                    ],
                  ),
